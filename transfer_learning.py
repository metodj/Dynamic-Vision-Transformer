...
from utils_transfer_learning import load_for_transfer_learning, progress_bar
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        optimizer.zero_grad()
        less_less_token_output, less_token_output, output  = net(inputs)
        loss = criterion(less_less_token_output, targets) + criterion(less_token_output, targets) + criterion(output, targets)
        loss.backward()
        optimizer.step()
